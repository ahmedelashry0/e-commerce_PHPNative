            ...
            <div class="container">
                <form class="form-horizontal" action="?do=Update" method="POST">
                    ...
                    <div class="form-group form-group-lg">
                        <label class="col-sm-2 control-label">Name</label>
                        <div class="col-sm-10 col-md-6">
                            <input type="text" name="Name" class="form-control" required="required" placeholder="<?php echo $item['Name'] ?>" />
                        </div>
                    </div>
                    <!-- End Item name Field -->
                    <!-- Start Item description Field -->
                    <div class="form-group form-group-lg">
                        <label class="col-sm-2 control-label">Description </label>
                        <div class="col-sm-10 col-md-6">
                            <input type="text" name="description" class="form-control" required="required" placeholder="<?php echo $item['Description'] ?>" />
                        </div>
                    </div>
                    <!-- End Item description Field -->
                    <!-- Start Item price Field -->
                    <div class="form-group form-group-lg">
                        <label class="col-sm-2 control-label">price</label>
                        <div class="col-sm-10 col-md-6">
                            <input type="text" name="price" class="form-control" required="required" placeholder="<?php echo $item['Price'] ?>" />
                        </div>
                    </div>
                    <!-- End Item price Field -->
                    <!-- Start Item country Field -->
                    <div class="form-group form-group-lg">
                        <label class="col-sm-2 control-label">Country</label>
                        <div class="col-sm-10 col-md-6">
                            <input type="text" name="country" class="form-control" required="required" placeholder="<?php echo $item['Country'] ?>" />
                        </div>
                    </div>
                    <!-- End Item country Field -->
                    <!-- Start Item status Field -->
